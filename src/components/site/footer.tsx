    ...
    <footer className="mt-20 border-t border-[color:var(--line)]">
      <div className="mx-auto flex w-full max-w-[1320px] flex-col gap-4 px-4 py-8 text-sm text-[color:var(--text-secondary)] md:flex-row md:items-center md:justify-between md:px-8 xl:px-[60px]">
        ...
        <div className="flex items-center gap-4">
          <Link href="/privacy" className="transition hover:text-[color:var(--text-primary)]">
            Privacy
          </Link>
          <Link href="/terms" className="transition hover:text-[color:var(--text-primary)]">
            Terms
          </Link>
          <Link href="/cookies" className="transition hover:text-[color:var(--text-primary)]">
            Cookies
          </Link>
        </div>
      </div>
